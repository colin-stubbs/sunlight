...
export SUNLIGHT_INTERNAL_SUBMISSION_PREFIX=${SUNLIGHT_INTERNAL_SUBMISSION_PREFIX:-https://sunlight}
...
export SUNLIGHT_INTERNAL_MONITORING_PREFIX=${SUNLIGHT_INTERNAL_MONITORING_PREFIX:-http://caddy}
...
logs:
  - shortname: ${SUNLIGHT_LOG_NAME}
    ...
    submissionprefix: ${SUNLIGHT_INTERNAL_SUBMISSION_PREFIX}
    monitoringprefix: ${SUNLIGHT_INTERNAL_MONITORING_PREFIX}
